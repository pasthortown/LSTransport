...
export class BinnacleService {
   ...
   url = environment.api_base + 'binnacle/';
   ...
   post(binnacle: Binnacle): Promise<any> {
      return this.http.post(this.url, JSON.stringify(binnacle), this.options).toPromise()
      .then( r => {
         return r.json();
      }).catch( error => { this.handledError(error.json()); });
   }

   put(binnacle: Binnacle): Promise<any> {
      return this.http.put(this.url, JSON.stringify(binnacle), this.options).toPromise()
      .then( r => {
         return r.json();
      }).catch( error => { this.handledError(error.json()); });
   }
